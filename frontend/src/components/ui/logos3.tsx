		...
		<section className="py-20 w-full overflow-hidden">
			...
			<div className="pt-10 md:pt-16 lg:pt-20">
				<div className="relative mx-auto flex items-center justify-center lg:max-w-5xl w-full">
					...
					<div className="absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-inherit to-transparent"></div>
					<div className="absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-inherit to-transparent"></div>
				</div>
			</div>
		</section>
	);
